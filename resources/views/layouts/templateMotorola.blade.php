...
<div class="content" style="display: flex;margin: 0px auto">
        ...
        <div class="card-body">
             ...
             <tr>
              ...
              <tr>
                <td>Category: </td>
                <td>{{$products[7]->category}}</td>
              </tr>
              <tr>
                <td>Retail price: </td>
                <td>{{$products[7]->price}}</td>
              </tr>
            </table>
        </div>
        </div>
        ...
        <tr>
              ...
              <tr>
                <td>Category: </td>
                <td>{{$products[8]->category}}</td>
              </tr>
              <tr>
                <td>Retail price: </td>
                <td>{{$products[8]->price}}</td>
              </tr>
            </table>
        </div>
        </div>

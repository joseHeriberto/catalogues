        ...
        <div id="myCarousel" class="carousel slide;" data-ride="carousel" style="width:93%; margin: 10px auto">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="{{asset('images/mootorola.jpg')}}"  alt="motorola" style="width:100%;"class="zoom">
                    </div>

                    <div class="item">
                      <img src="{{asset('images/samsung.jpg')}}"  alt="samsung" style="width:100%;"class="zoom">
                    </div>
                  
                    <div class="item">
                      <img src="{{asset('images/huawei.jpg')}}" alt="huawei" style="width:100%;"class="zoom">
                    </div>
                  </div>
